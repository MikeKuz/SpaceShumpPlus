...
public class Main : MonoBehaviour
{
    ...
    public void SpawnEnemy()
    {
        ...
        // Разместить вражеский корабль над экраном в случайной озиции X
    ...
    public void Restart()
    {
        //Перезагрузить _Scebe_0, чтобы перезапустить игру
    ...
    static public WeaponDefinition GetWeaponDefinition(WeaponType wt)
    {
        ...
        //поэтому следующая инсрукция играет важную роль
