...
public class Hero : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("Hero.Awake() - Attempted to assign second Hero.S! Попытка назначить второго героя");

        }
        //fireDelegate += TempFire;

        //Очистить макссив weapons и начать игру с 1 бластером
        ClearWeapons();
    ...
    void Update()
    {
        ...
        //Повернуть каорабль, что бы придать ощущение динамизма
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        //Если защитное поле столкнулось с вражеским кораблем - уменьшить уровень защиты на 1 
        if(go.tag=="Enemy")
        {
            shieldLevel--;
            Destroy(go);
    ...
    public void AsbsorbPowerUp(GameObject go)
    {
