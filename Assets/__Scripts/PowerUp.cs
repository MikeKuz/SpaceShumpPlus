...
public class PowerUp : MonoBehaviour
{
    ...
    // значение, а Y максимальное значеине для метода Random.Range(),
    ...
    void Awake()
    {
        ...
        // точку, находящуюся на поверхности сферы с радиусом 1м и с центром
        // в начале координат
        vel.z = 0;
        vel.Normalize();
    ...
    void Update()
    {
        ...
        //Эффект растворения куба PowerUp с течениемвремени 
        //Со значениями по умолчанию бонус будет существовать 10 секунд
        // а затем астворится в течении 4 секунд
