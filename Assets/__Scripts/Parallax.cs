...
public class Parallax : MonoBehaviour
{
    ...
    public float scrollSpeed = -30f;    //motionMult определяет степень реакции
                                        // панелей на перемещение корабля игрока 
    ...
    void Update()
    {
        ...
        //Сместить панель panel[1], что бы создать эффект непрерывности
        // звездного поля
        if (tY >= 0)
        {
